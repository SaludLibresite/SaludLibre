              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {services.map((service, index) => (
                  <motion.div
                    ...
                    className="relative"
                  >
                    <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 transition-shadow duration-300 hover:shadow-xl min-h-[240px] flex flex-col">
                      <div
                        className={`w-16 h-16 rounded-2xl ${service.color} flex items-center justify-center mb-6 text-3xl flex-shrink-0`}
                      >
                        {service.icon}
                      </div>
