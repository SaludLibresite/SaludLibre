        ...
        <div className="lg:hidden space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="relative flex-shrink-0">
                  ...
                  {isBirthday(doctor.fechaNacimiento) && (
                    <div className="absolute -top-2 -left-2 bg-pink-500 text-white text-xs font-bold px-2 py-1 rounded-full animate-pulse shadow-md">
                      🎉
                    </div>
                  )}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h1 className="text-xl font-bold mb-1">{doctor.nombre}</h1>
                      <p className="text-blue-100 font-medium">{doctor.especialidad}</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className={`w-3 h-3 rounded-full ${isAvailable ? "bg-green-400" : "bg-gray-400"}`}></div>
                  ...
                  <div className="flex items-center gap-2 text-sm text-blue-100 mb-3">
                    ...
                    <span className="truncate">{doctor.formattedAddress || doctor.ubicacion}</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{doctor.horario || "Horarios a consultar"}</p>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-purple-600 font-medium">
                          {doctor.ageGroup === "menores" ? "Solo menores" :
                ...
                <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl p-4 border border-pink-100">
                  {isBirthday(doctor.fechaNacimiento) ? (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-pink-800">¡Feliz cumpleaños!</p>
                        <p className="text-sm text-pink-700">
                          Hoy cumple {calculateAge(doctor.fechaNacimiento)} años
                        </p>
                      </div>
                    </div>
                  ) : (
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">
                            {calculateAge(doctor.fechaNacimiento)} años de edad
                          </p>
                          <p className="text-sm text-gray-600">
                            Cumpleaños: {formatBirthday(doctor.fechaNacimiento)}
                          </p>
                        </div>
                      </div>
                    )
              ...
              <div className="border-t pt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-3 px-4 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors font-medium"
                  >
          ...
          >
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-4 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              {currentUser ? "Agendar Cita" : "Iniciar Sesión"}
            </button>

            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-700 text-center">
                {currentUser ? "Completa el formulario y te contactaremos" : "Crea una cuenta para agendar tu cita médica"}
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
                ...
                <div className="relative bg-gradient-to-r from-blue-600 to-blue-700 p-8 text-white">
                  <div className="flex items-start gap-6">
                    <div className="relative flex-shrink-0">
                      ...
                      {isBirthday(doctor.fechaNacimiento) && (
                        <div className="absolute -top-3 -left-3 bg-pink-500 text-white text-sm font-bold px-3 py-1 rounded-full animate-pulse shadow-md">
                          🎉
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <p className="text-xl text-blue-100 font-medium">{doctor.especialidad}</p>
                        </div>
                        <div className="flex items-center gap-3">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="font-semibold text-gray-900">Estado de verificación</p>
                            <p className="text-blue-600 font-medium">
                              {doctor.verified ? "Verificado por la plataforma" : "En proceso de verificación"}
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl p-6 border border-pink-100">
                          {isBirthday(doctor.fechaNacimiento) ? (
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <p className="text-xl font-semibold text-pink-800">¡Feliz cumpleaños!</p>
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="space-y-3">
                          <a
                            href={`tel:${doctor.telefono}`}
                            className="flex items-center gap-3 px-4 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors font-medium"
                          >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-3 px-4 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors font-medium"
                          >
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                              <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                            </svg>
                          ...
                          <a
                            href={`mailto:${doctor.email}`}
                            className="flex items-center gap-3 px-4 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-colors font-medium"
                          >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <button
                  onClick={handleAppointmentClick}
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-3 group mb-4"
                >
                  <svg
              ...
              >
                ...
                <div className="space-y-3">
                  <a
                    href={`tel:${doctor.telefono}`}
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors duration-200 font-medium"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors duration-200 font-medium"
                  >
                    <svg
                      className="w-5 h-5"
                      viewBox="0 0 24 24"
                  ...
                  <a
                    href={`mailto:${doctor.email}`}
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-colors duration-200 font-medium"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
