        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600 max-w-md">
              ...
              Argentina. Tecnología y cuidado humano para tu bienestar.
            </p>
            <div className="flex space-x-6">
              <a href="https://www.instagram.com/saludlibre.ar" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-600">
              ...
              <a href="https://www.linkedin.com/company/saludlibre/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-600">
